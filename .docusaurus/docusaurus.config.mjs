...
export default {
  ...
  "organizationName": "606",
  "projectName": "avro-wiki-docusaurus",
  "onBrokenLinks": "throw",
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/606/avro-wiki-docusaurus/tree/main/"
        },
        "theme": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Avro Wiki. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
